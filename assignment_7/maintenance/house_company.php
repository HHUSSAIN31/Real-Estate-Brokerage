...
if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
    if ($_SESSION['username'] = "admin" && $_SESSION['password'] = "admin") {
        ...
        header("location: http://clabsql.clamv.jacobs-university.de/~hhussain/assignment_7");
    }
} else {
    header("location: http://clabsql.clamv.jacobs-university.de/~arathi/assignment_7");
}
