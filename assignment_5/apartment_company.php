...
<!-- Database connection is included from 'connect.php' -->
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($connect->connect_error) {
        ...
        $stmt = $connect->prepare("INSERT INTO Apartment_company (S_id, A_floor, City, Zip_code, Size, N_rooms, N_bath, Furnished, Price) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
