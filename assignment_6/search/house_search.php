...
<body>
    ...
    <div class="container">
        ...
        if (isset($_GET['City'])) {
            ...
            $sql = "SELECT Size, Price, City FROM House_single WHERE City = '$city'
            UNION
            SELECT Size, Price, City FROM House_company WHERE City = '$city'";

            $result = $connect->query($sql);

            echo "<h2>RESULTS FOR HOUSES</h2>";
            echo "<table>";
            echo "<tr><th>Size</th><th>City</th><th>House Price</th></tr>";
