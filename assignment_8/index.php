...
<body>
    ...
    <nav>
        <ul>
            <li><a href="http://clabsql.clamv.jacobs-university.de/~hhussain/assignment_8/search">Buy</a></li>
            ...
            <li class="dropdown">
                <div class="dropdown-content">
                    <a href="http://clabsql.clamv.jacobs-university.de/~hhussain/assignment_8/login/login.php">Log In</a>
                </div>
            </li>
        </ul>
